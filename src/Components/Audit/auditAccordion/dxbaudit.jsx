...
const validationSchema = yup.object({
    ...
    dxb_groupscompleted: yup.string().matches(/^[0-9]+$/, 'enter number'),
    dxb_totalaudited: yup.string().matches(/^[0-9]+$/, 'enter number'),
    dxb_onboardingcalls: yup.string().matches(/^[0-9]+$/, 'enter number'),
});
                ...
                >
                    <div style={{ display: 'flex', flexDirection: 'row', flex: 1 }}>
                        ...
                        <TextField
                            sx={{ width: '100%' }}
                            variant="outlined"
                            id="dxb_onboardingcalls"
                            name="dxb_onboardingcalls"
                            value={formik.values.dxb_onboardingcalls}
                            onChange={formik.handleChange}
                        />
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'row', flex: 1 }}>
                        ...
                        <TextField
                            sx={{ width: '100%' }}
                            variant="outlined"
                            id="dxb_groupscompleted"
                            name="dxb_groupscompleted"
                            value={formik.values.dxb_groupscompleted}
                            onChange={formik.handleChange}
                        />
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'row', flex: 1 }}>
                        ...
                        <TextField
                            ...
                            variant="outlined"
                            id="dxb_totalaudited"
                            name="dxb_totalaudited"
                            value={formik.values.dxb_totalaudited}
                            onChange={formik.handleChange}
                        />
                    </div>
                </div>
