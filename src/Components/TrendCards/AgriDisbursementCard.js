...
export default function AgriDisbursementCard() {
    ...
    const getTNAgriDisbursement1 = async () => {
        try {
            ...
            await getTNAgriDisbursement2();
        } catch (err) {
            console.log(err);
        }
    };

    const getTNAgriDisbursement2 = async () => {
        try {
    ...
    let overallCardValue = Object.assign(
        {},
        {
            prospectsourced: mdata?.disbursment?.prospectsourced?.total,
            creditAccepted: mdata?.disbursment?.creditaccepted?.total,
            disbursed: mdata?.disbursment?.disbursed?.total,
            disbursedamount: mdata?.disbursment?.disbursedamount?.total,
            trend: false,
            icon: null,
            color: null,
            month: 'Overall',
    ...
    return (
        ...
        >
            ...
            <Grid item lg={3.5} md={3.5} sm={12} xs={12}>
                <DisbursementCard cardValue={overallCardValue} />
            </Grid>
        </Grid>
    );
}
