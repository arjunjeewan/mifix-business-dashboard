...
export default function DXBJlgDisbursement() {
    ...
    const getTNjlgDisbursemen1 = async () => {
        try {
            ...
            await getTNjlgDisbursemen2();
        } catch (err) {
            console.log(err);
        }
    };

    const getTNjlgDisbursemen2 = async () => {
        try {
