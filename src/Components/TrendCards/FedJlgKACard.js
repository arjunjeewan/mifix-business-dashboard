...
export default function JLGKarnatakaCard() {
    ...
    const getKAJlgDisbursement1 = async () => {
        try {
            ...
            await getKAJlgDisbursement2();
        } catch (err) {
            console.log(err);
        }
    };

    const getKAJlgDisbursement2 = async () => {
        try {
