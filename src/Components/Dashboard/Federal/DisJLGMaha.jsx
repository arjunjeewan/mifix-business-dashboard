...
import { option3 } from '../../../Assets/chartOptions';
...
import JLGMaharashtraCard from '../../TrendCards/FedJlgMHCard';
import Snackbar from '../../Snackbar/Snackbar';

const FedDisJLGMaha = ({ bank, state, product }) => {
    ...
    const [toggleMH, setToggleMH] = useState('trend');
            ...
            <AccordionDetails>
                <Grid item xs={12} md={3}>
                    ...
                    >
                        <div
                            style={{
                                display:
                                    toggleMH === 'chart' ? 'inline-block' : 'none',
                            }}
                        >
                            <CustomDatePicker
                ...
                {toggleMH === 'chart' && (
                    <Graphoption
                        ...
                        graphtype={['bar', 'line']}
                        type="disbursment"
                        chartName="Federal_JLG_Disb_Maharashtra"
                        graphKeys={[
                            'date',
                            'Sourced',
                            'Disbursed',
                ...
                {toggleMH === 'trend' && <JLGMaharashtraCard />}
