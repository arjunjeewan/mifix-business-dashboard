...
import TamilNaduDisbursementCard from '../../TrendCards/DxbJlgTNCard';
// import { useSnackbar } from "notistack";
import Snackbar from '../../Snackbar/Snackbar';

const DisJLGtn = ({ data, bank, state, product, type }) => {
    let option = [];
            ...
            <AccordionDetails>
                ...
                {toggleTN === 'chart' && (
                    <Graphoption
                        ...
                        graphtype={['bar', 'line']}
                        type="disbursment"
                        chartName="Dhanlaxmi_JLG_Disb_Tamilnadu"
                        graphKeys={[
                            'date',
                            'Sourced',
                            'Disbursed',
                ...
                {toggleTN === 'trend' && <TamilNaduDisbursementCard />}
